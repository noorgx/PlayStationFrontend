    ...
    <div dir="rtl">
      <Container className="mt-4">
        <h2 className="mb-4 text-center">
          <FaUtensils className="me-2" /> المخزن <FaGlassCheers className="ms-2" />
        </h2>

        {/* Only show "Add Food/Drink" button if user is admin */}
        {userRole === 'admin' && (
          <Button variant="primary" onClick={() => setShowModal(true)} className="mb-3">
            <FaPlus className="me-2" /> إضافة الي محزن
          </Button>
        )}
        ...
        <Modal show={showModal} onHide={resetForm}>
          <Modal.Header closeButton>
            <Modal.Title>
              ...
              {editMode ? 'تعديل المخزن' : 'إضافة الي مخزن'}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group controlId="totalPrice" className="mb-3">
                <Form.Label>السعر الاصلي</Form.Label>
                <Form.Control
                  type="number"
                  name="total_price"
